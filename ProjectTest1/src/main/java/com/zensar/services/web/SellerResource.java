...
public class SellerResource {
	...
	@PostMapping
	public String createSeller(@RequestParam("sellerId") int sellerId, @RequestParam("sellerPrice") float sellerPrice,@RequestParam("user") int  userId)
			
	
	{
		
		User user = userService.findUserById(userId);
		Seller seller = new Seller(sellerId,sellerPrice, user);
