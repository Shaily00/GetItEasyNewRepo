...
//	private Product productPrice;
	...
	public Seller(int sellerId, Float sellerPrice, User user) 
	{
		super();
	...
	/*
	 * public Product getProductPrice() { return productPrice; }
	 * 
	 * public void setProductPrice(Product productPrice) { this.productPrice =
	 * productPrice; }
	 */
